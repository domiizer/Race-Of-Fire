...
public class Table extends FMXScreen {
    ...
    public Table(FMXGame game) {
        ...
        table = g.newImage("table2.png", FMXGraphics.ImageFormat.ARGB4444);
        big = g.newImage("bet roombig.png",FMXGraphics.ImageFormat.ARGB4444);
    ...
    public void paint(float deltaTime) {
        ...
        g.drawImage(table, constan.SCREEN_HEIGHT/2-(378+20), constan.SCREEN_WIDTH-360,0,0,756,174);
        g.drawImage(table, constan.SCREEN_HEIGHT/2-(378-20), constan.SCREEN_WIDTH-210,0,174,756,174);
        g.drawImage(constan.statbtnX,20,constan.SCREEN_WIDTH-60,0,0,59,38);
//        g.drawImage(table, constan.SCREEN_HEIGHT/2-378, constan.SCREEN_WIDTH-348);
//        g.drawImage(table, constan.SCREEN_HEIGHT/2-378, constan.SCREEN_WIDTH-348);
//        g.drawImage(table, constan.SCREEN_HEIGHT/2-378, constan.SCREEN_WIDTH-348);
//        g.drawImage(table, constan.SCREEN_HEIGHT/2-378, constan.SCREEN_WIDTH-348);
//        g.drawImage(table, constan.SCREEN_HEIGHT/2-378, constan.SCREEN_WIDTH-348);
